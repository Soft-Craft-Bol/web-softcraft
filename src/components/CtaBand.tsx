...
export default function CtaBand({ title, text, action }: CtaBandProps) {
  return (
    <div className="flex flex-col items-center justify-between gap-6 rounded-2xl border border-white/12 bg-panel p-8 text-center md:flex-row md:p-10 md:text-left">
