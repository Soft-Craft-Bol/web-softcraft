...
export const SERVICES: Service[] = [
  {
    ...
    icon: HiGlobeAlt,
    problem: "Necesitas una web clara o un sistema que te ayude a trabajar mejor.",
    includes: "Ordenamos el contenido, diseñamos la experiencia y construimos la solución.",
    benefit: "Una presencia digital que explica lo que haces y facilita el siguiente paso.",
    accent: "magenta",
  },
  {
    title: "Apps Móviles",
    icon: HiDevicePhoneMobile,
    problem: "Tus clientes o tu equipo necesitan resolver algo desde el celular.",
    includes: "Diseñamos el flujo, desarrollamos la app y acompañamos su puesta en marcha.",
    benefit: "Una solución pensada para el día a día de quienes la usan.",
    accent: "gold",
  },
  {
    title: "Software a Medida",
    icon: HiCommandLine,
    problem: "Las herramientas que usas no siguen la forma real de trabajar.",
    includes: "Entendemos el proceso, ordenamos el alcance y construimos la herramienta contigo.",
    benefit: "Un sistema que se adapta a tu negocio.",
    accent: "coral",
  },
  {
    title: "Inteligencia Artificial",
    icon: HiRocketLaunch,
    problem: "Hay tareas repetitivas o información que te quita tiempo cada semana.",
    includes: "Encontramos dónde aporta la IA y la integramos con un uso responsable.",
    benefit: "Más tiempo para decidir y menos trabajo manual.",
    accent: "magenta",
  },
  {
    ...
    includes: "Mapeamos el flujo y conectamos las tareas que pueden hacerse automáticamente.",
    benefit: "Un proceso más ordenado y fácil de seguir.",
    accent: "gold",
  },
  {
    title: "Puesta en marcha y continuidad",
    icon: HiServerStack,
    problem: "Tu solución necesita salir, mantenerse disponible y crecer con orden.",
    includes: "Configuramos el entorno, publicamos y acompañamos los siguientes ajustes.",
    benefit: "Una base estable para seguir trabajando.",
    accent: "coral",
  },
  {
    title: "Soporte y mejoras",
    icon: HiWrenchScrewdriver,
    problem: "Tu sistema necesita atención, mantenimiento y mejoras después de publicarse.",
    includes: "Resolvemos incidencias, damos mantenimiento y priorizamos mejoras.",
