  ...
  return (
    <div className="content-page testimonials-page py-12 lg:py-20 min-h-[calc(100dvh-5rem)] flex flex-col justify-between">
      ...
      <section className="page-section testimonials-cta-section pt-8">
        <div className="site-container testimonials-cta-inner flex flex-col sm:flex-row items-center justify-between gap-6 p-8 sm:p-10 rounded-2xl border border-[var(--sc-line)] bg-[var(--sc-surface)]">
